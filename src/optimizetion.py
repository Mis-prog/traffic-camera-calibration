...
class Optimizer:
    ...
    def error_point_to_point(self, line_known: tuple[Point2D, Point2D], line_predicted: tuple[Point2D, Point2D]) -> float:
    ...
    def residuals(self, params: np.ndarray,
        ...
        for known_start, known_end in lines:
            ...
            error = self.error_point_to_point((known_start_2D, known_end_2D), (predicted_start_2D, predicted_end_2D))
